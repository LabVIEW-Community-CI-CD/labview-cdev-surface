...
Describe 'Self-hosted machine certification workflow contract' {
    ...
    It 'keeps push matrix contexts explicit and switch-enabled' {
        ...
        $script:workflowContent | Should -Match 'setup_name:\s*"host-2025-desktop-windows"[\s\S]*?contract_labview_year:\s*"2026"'
    ...
    It 'runs per-bitness MassCompile and VI Analyzer certification with summary fields' {
        ...
        $script:workflowContent | Should -Match 'matrix\.contract_labview_year'
        $script:workflowContent | Should -Match 'execution_contract_year_unmapped'
        $script:workflowContent | Should -Match 'PSObject\.Properties\[\$contractYear\]'
        ...
        $script:workflowContent | Should -Match 'execution-contract\.outputs\.contract_year'
